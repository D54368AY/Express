...
app.get('/',(req,res)=>{
    let data=fs.readFile('./post.json', 'utf-8', function(err, data) {  
...
app.post(`/fupdatepost/:id`,(req,res)=>{
    ...
    res.redirect('http://localhost:7799')
})
...
app.get(`/deletepost/:id`,(req,res)=>{
    fs.readFile('./post.json', 'utf-8', function(err, data) {
       ...
       /*  res.redirect('http://localhost:7799');  lagging one state behind  */
       res.writeHead(301,{Location:'/'}) //alernate to redirect
